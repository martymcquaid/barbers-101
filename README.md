...
- **Dev Server URL**: `http://127.0.0.1:5211`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/cd2cb6a9-9855-42ab-a278-205358ab1816/preview`
- **Port**: `5211`
...
4. The dev server is accessible at `http://127.0.0.1:5211`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/cd2cb6a9-9855-42ab-a278-205358ab1816/preview`
